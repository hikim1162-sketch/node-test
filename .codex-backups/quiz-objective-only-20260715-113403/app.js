...
function loadQuizState() {
  const initial = { questions: mergeDefaultQuizQuestions([]), current: 0, solvedMap: {}, wrongSet: [], bookmarkSet: [], solvedDates: [], darkMode: false, examMode: false, search: "", filter: "all", answerVisible: false, selectedChoice: null };
  try {
...
function quizPage() {
  ...
  return `${header("영어 문제 풀이")}<main class="quiz-page ${quizState.darkMode ? "dark" : ""}">
    ...
    <section class="quiz-hero-dashboard">
      <div><p class="eyebrow">PRACTICAL RC TRAINING</p><h2>실전형 영어 문제 풀이</h2><span>토익 RC 형식은 참고하되, 문제와 지문은 업무·기술 맥락에 맞춘 자체 제작 연습입니다.</span><div class="quiz-mix-line"><b>오늘 추천: 문법 2문항 + 짧은 독해 1문항</b><span>최근 약한 유형 중심으로 오답 복습까지 이어집니다.</span></div></div>
