...
export default async function handler(request) {
  ...
  try {
    ...
    const prompt = `You are a Korean English learning tutor. Help the user understand and learn this sentence: ${sentence}\nReturn ONLY valid JSON with a sections array. Use exactly two sections in this order and these exact Korean titles: 뜻, 유사문장. 뜻 includes a natural Korean meaning and one-line meaning summary. 유사문장 provides 2-3 new English examples, Korean translations, and the shared pattern. Do not include word-by-word meanings, grammatical analysis, or commonly confused grammar. Keep it concise and actionable. Do not use markdown.`;
